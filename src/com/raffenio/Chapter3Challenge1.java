...
public class Chapter3Challenge1 {
    ...
    public static void main(String[] args) {
        ...
        //get a list of all people names
        // Answer 1 goes here
        List<String> peopleNames = people.stream().map(person->person.name).toList();
        ...
        //get the list of all the blue cars
        List<Car> blueCars = cars.stream().filter(car->car.color.equals("blue")).toList();
